          ...
          <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
              <h1 className="dark:text-white title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">India's No.1 Online
                <br className="dark:text-white hidden lg:inline-block" />Video Store
              </h1>
              <p className="dark:font-bold mb-8 leading-relaxed">Created Video Store Using React and Node JS. And Sign In & Sign Up Authentication Is Used With The Help Of MERN Stack. Axios is Used In This Project. Tailwind Is Used For Cascading Style Sheets</p>
